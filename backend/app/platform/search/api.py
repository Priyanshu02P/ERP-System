...
from app.platform.search.schemas import AvailabilityCheckRequest, AvailabilityCheckResponse, AvailabilityResultItem
from app.master_data.product.models import Product
from app.wms.inventory.service import InventoryService
from app.platform.seed.service import seed_synthetic_data
